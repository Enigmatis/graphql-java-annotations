        ...
        for (DirectiveInfo directiveInfo : directiveInfos) {
            if (element instanceof GraphQLFieldDefinition) {
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onField(new AnnotationsWiringEnvironmentImpl<>((GraphQLFieldDefinition) element, directiveInfo.toDirective()));
            } else if (element instanceof GraphQLObjectType) {
                assertLocation(directiveInfo, element, Introspection.DirectiveLocation.OBJECT);
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onObject(new AnnotationsWiringEnvironmentImpl<>((GraphQLObjectType) element, directiveInfo.toDirective()));
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onArgument(new AnnotationsWiringEnvironmentImpl<>((GraphQLArgument) element, directiveInfo.toDirective()));
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onInterface(new AnnotationsWiringEnvironmentImpl<>((GraphQLInterfaceType) element, directiveInfo.toDirective()));
            } else if (element instanceof GraphQLUnionType) {
                assertLocation(directiveInfo, element, Introspection.DirectiveLocation.UNION);
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onUnion(new AnnotationsWiringEnvironmentImpl<>((GraphQLUnionType) element, directiveInfo.toDirective()));
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onEnum(new AnnotationsWiringEnvironmentImpl<>((GraphQLEnumType) element, directiveInfo.toDirective()));
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onEnumValue(new AnnotationsWiringEnvironmentImpl<>((GraphQLEnumValueDefinition) element, directiveInfo.toDirective()));
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onScalar(new AnnotationsWiringEnvironmentImpl<>((GraphQLScalarType) element, directiveInfo.toDirective()));
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onInputObjectType(new AnnotationsWiringEnvironmentImpl<>((GraphQLInputObjectType) element, directiveInfo.toDirective()));
                ...
                element = directiveInfo.getSchemaDirectiveWiring()
                        .onInputObjectField(new AnnotationsWiringEnvironmentImpl<>((GraphQLInputObjectField) element, directiveInfo.toDirective()));
            }
