...
public class DefaultTypeFunctionTest {
    ...
    public List<List<@graphql.annotations.GraphQLNonNull String>> listMethod() {
        return null;
    }

    @SuppressWarnings("unused")
    public Iterable<Iterable<@graphql.annotations.GraphQLNonNull String>> iterableMethod() {
        return null;
    }

    @SuppressWarnings("unused")
    public Collection<Collection<@graphql.annotations.GraphQLNonNull String>> collectionMethod() {
        return null;
    }


    @SuppressWarnings("unused")
    public Stream<List<@graphql.annotations.GraphQLNonNull String>> streamMethod() {
        return null;
    }

    @SuppressWarnings("unused")
    public Set<Set<@graphql.annotations.GraphQLNonNull String>> setMethod() {
        return null;
    }
    ...
    @SuppressWarnings("unused")
    public Optional<List<@graphql.annotations.GraphQLNonNull String>> optionalMethod() {
